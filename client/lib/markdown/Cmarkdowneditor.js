(function ($) {	
	...
	$.markdownEditor = {
		...
		toolbars: {
			'default': [['h1','h2','h3'], ['bold','italic'], ['link'], ['quote', 'code'], ['hr']]
		}
	};
	...
	$.markdownEditor.ui.prototype.clickHandler = function(callback) {
		var that = this;
		return function (e) { e.preventDefault(); callback.apply(null, [that.$textarea.caret(), that.$textarea]); that.$textarea.preview(); };
	}
